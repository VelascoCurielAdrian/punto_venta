...
--EJECUTABLE
--==========================================================
SELECT crear_categoria('Despensa', 'Enlatados, granos');
SELECT crear_categoria('Lacteos', 'Queso, Leche');
SELECT crear_categoria('Refrescos', 'Coca, Agua');
...
--EJECUTABLE
--==========================================================
SELECT actualizar_categoria('Despensa General', 'Enlatados, granos, avena', 1, TRUE);
...
--EJECUTABLE
--==========================================================
SELECT consultar_categoria(1);

--FUNCIÓN PARA ELIMINAR UNA CATEGORIA PRODUCTO
--==========================================================
CREATE
OR REPLACE FUNCTION eliminar_categoria(categoria_id INTEGER) RETURNS BOOLEAN AS $$ 
BEGIN
UPDATE
    categoria_producto
SET
...
--EJECUTABLE
--==========================================================
SELECT crear_producto('Coca cola', 'coca cola 600ml', 20.22, 1);
SELECT crear_producto('Jugo', 'jugo valle 600ml', 21.60, 3);
SELECT crear_producto('Arroz', 'arroz del valle', 28.20, 2);
...
--EJECUTABLE
--==========================================================
SELECT actualizar_producto('Coca cola', 'coca cola 3LT', 20.22, 1, TRUE, 1);
...
--EJECUTABLE
--==========================================================
SELECT consultar_producto(1);

--FUNCIÓN PARA ELIMNAR UN PRODUCTO
--==========================================================
CREATE
OR REPLACE FUNCTION eliminar_producto(categoria_id INTEGER) RETURNS BOOLEAN AS $$ 
BEGIN
UPDATE
    producto
SET
